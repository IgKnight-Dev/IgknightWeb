import"./chunk-EJUJSVO6.js";var t=[{id:"css-introduction",title:"Introduction to CSS",slug:"css-introduction"},{id:"css-selectors-properties",title:"Selectors & Properties",slug:"css-selectors-properties"},{id:"css-colors-fonts",title:"Colors & Fonts",slug:"css-colors-fonts"},{id:"css-box-model",title:"The Box Model",slug:"css-box-model"},{id:"css-display-position",title:"Display & Positioning",slug:"css-display-position"},{id:"css-flexbox",title:"Flexbox Layout",slug:"css-flexbox"},{id:"css-grid",title:"CSS Grid",slug:"css-grid"},{id:"css-position-display",title:"CSS Position & Display Explained Simply",slug:"css-position-display"},{id:"css-spacing-sizing",title:"Margin, Padding & Sizing",slug:"css-spacing-sizing"},{id:"css-background-border",title:"Backgrounds & Borders",slug:"css-background-border"},{id:"css-pseudo-classes",title:"Pseudo-classes & Pseudo-elements",slug:"css-pseudo-classes"},{id:"css-transitions-animations",title:"Transitions & Animations",slug:"css-transitions-animations"},{id:"css-responsive",title:"Responsive Design & Media Queries",slug:"css-responsive"},{id:"css-variables",title:"CSS Variables",slug:"css-variables"},{id:"css-best-practices",title:"Best Practices & Real Projects",slug:"css-best-practices"}];function o(e){switch(e){case"css-introduction":return{slug:"css-introduction",title:"What is CSS?",content:`
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3A8} Real-World Analogy</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4CC} What Can CSS Do?</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9E0} Why "Cascading"?</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F6E0}\uFE0F How Do You Use It?</h3>
          <ul class="list-disc list-inside text-gray-300">
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F50D} Where You'll See CSS</h3>
        ...
        `,proTip:"Start small. Style one element at a time and use browser dev tools (Inspect Element) to play around and see what happens!",codeSamples:[{language:"html",code:`
          ...
          <body>
            ...
            <p>This page looks better with CSS \u{1F609}</p>
          </body>
          </html>`},{language:"css",code:`
          ...
          p {
            color: #334155;
            line-height: 1.5;
          }`}]};case"css-syntax-selectors":return{slug:"css-syntax-selectors",title:"CSS Syntax & Selectors",content:`
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9E9} Basic CSS Rule Syntax</h3>
...
selector {
  property: value;
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3AF} Types of Selectors (The Essentials)</h3>
          <ul class="list-disc list-inside text-gray-300">
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F916} Real-World Analogy</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4AC} Tip:</h3>
          <p>Use <code>.class</code> for groups of elements, and <code>#id</code> only once per page. Keep your selectors clean and clear.</p>
        `,proTip:"Inspect your elements in the browser and play with styles in real-time \u2014 it\u2019s the best way to learn selectors!",codeSamples:[{language:"css",code:`
        /* Element Selector */
        h1 {
          color: #f97316;
        }
        ...
        #main-title {
          ...
          text-align: center;
              ...
              <div class="card">
                <p>This is a card.</p>
              </div>`}]};case"css-colors-fonts":return{slug:"css-colors-fonts",title:"Colors & Fonts in CSS",content:`
          <p>Let\u2019s add some life to your page! \u{1F308} With just a few lines of CSS, you can make text colorful, fun, serious, or fancy \u2014 it\u2019s all up to the vibe you want to create.</p>

          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3A8} Setting Text Colors</h3>
          <ul class="list-disc list-inside text-gray-300">
...
p {
  color: #10b981; /* emerald green */
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F58C}\uFE0F Background Colors</h3>
...
.card {
  ...
  color: white;
          ...
          <ul class="list-disc list-inside text-gray-300">
            <li><strong>Color</strong> grabs attention or sets the mood (like party vs. funeral \u{1F389}\u26B0\uFE0F)</li>
        ...
        `,proTip:"Google Fonts is your best friend for stylish web typography. Just include the link and set it using font-family!",codeSamples:[{language:"css",code:`
        body {
        ...
        <div class="card">
        ...
        </div>`}]};case"css-box-model":return{slug:"css-box-model",title:"Understanding the Box Model",content:`
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4E6} What\u2019s Inside a CSS Box?</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4D0} Visual Representation</h3>
...
+---------------------------+
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4AC} Common CSS Properties</h3>
          <ul class="list-disc list-inside text-gray-300">
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Tip:</h3>
          <p>Always use <code>box-sizing: border-box</code> to avoid layout headaches. It makes sizing predictable!</p>
        `,proTip:"Try inspecting any element in your browser (Right-click \u2192 Inspect). You\u2019ll see the full box model live!",codeSamples:[{language:"css",code:`
      * {
      ...
      <div class="card">
        <p>This card has padding, margin, and a border \u2014 it's all part of the box model!</p>
      </div>`}]};case"css-display-position":return{slug:"css-display-position",title:"Display & Position Explained",content:`
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9F1} Display Types</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4CD} CSS Positioning</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1FA91} Real-Life Analogy</h3>
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4AC} Common Properties</h3>
          <ul class="list-disc list-inside text-gray-300">
        ...
        `,proTip:"Use position: sticky for headers or sidebars that scroll with you but stay visible when needed!",codeSamples:[{language:"css",code:`
    .box {
      width: 150px;
      height: 150px;
    ...
    <div style="position: relative;">
    ...
    </div>`}]};case"css-flexbox":return{slug:"css-flexbox",title:"Flexible Layouts with Flexbox",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4E6} Basic Flexbox Setup</h3>
...
.container {
  display: flex;
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F504} Wrapping with Flexbox</h3>
      <pre class="bg-[#1F2937] p-4 rounded-lg overflow-auto text-green-400"><code>
.container {
  flex-wrap: wrap;
}
    ...
    `,proTip:"Flexbox is ideal for one-dimensional layouts \u2014 use Grid when you need full rows *and* columns.",codeSamples:[{language:"html",code:`
      <div class="container">
      ...
      .box {
        ...
        border-radius: 8px;
              ...
              `}]};case"css-grid":return{slug:"css-grid",title:"Mastering CSS Grid",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4E6} Real Life Analogy</h3>
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9F1} Basic Grid Setup</h3>
      <pre class="bg-[#1F2937] p-4 rounded-lg overflow-auto text-green-400"><code>
.container {
  display: grid;
  ...
  gap: 20px;
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F522} Grid Terms Made Simple</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3AF} Placing Items</h3>
...
.item2 {
  grid-row: 2;
    ...
    `,proTip:'Use tools like <a class="underline text-blue-400" href="https://cssgrid-generator.netlify.app/" target="_blank">CSS Grid Generator</a> to visualize your layout!',codeSamples:[{language:"html",code:`
<div class="container">
  <div class="box">1</div>
  <div class="box">2</div>
  <div class="box">3</div>
  <div class="box">4</div>
    ...
    .box {
      ...
      border-radius: 8px;
            ...
            `}]};case"css-position-display":return{slug:"css-position-display",title:"CSS Position & Display Explained Simply",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9FE} Common Display Values</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4CD} Position Types (With Examples)</h3>
      <ul class="list-disc list-inside text-gray-300">
...
.floating-box {
  ...
  color: white;
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Quick Tips</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:'Use Chrome DevTools to right-click \u2192 "Inspect" and experiment with different display and position styles live!',codeSamples:[{language:"html",code:`
<div class="banner">
  <p>Hello! I'm sticky.</p>
    ...
    .banner {
      ...
      font-weight: bold;
            ...
            `}]};case"css-spacing-sizing":return{slug:"css-spacing-sizing",title:"Margin, Padding & Sizing",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4CF} Margin vs Padding (Room Analogy)</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F522} How to Use Them</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4D0} Sizing Content</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9EA} Pro Tip</h3>
    ...
    `,proTip:"Use DevTools (right-click \u2192 Inspect) to visually test margins and paddings live!",codeSamples:[{language:"css",code:`
.box {
  padding: 20px;
  margin: 30px;
...
* {
  box-sizing: border-box;
}`}]};case"css-background-border":return{slug:"css-background-border",title:"Backgrounds & Borders",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3A8} Background Basics</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F58C}\uFE0F Border Basics</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9E0} Real-World Vibes</h3>
      <p>If a <code>&lt;div&gt;</code> is a gift box:  
        <br/>\u{1F381} Background is the wrapping paper  
        <br/>\u{1F380} Border is the ribbon wrapped around it  
        <br/>\u2728 Border-radius makes it a soft pillow instead of a hard box!
      </p>
    `,proTip:"You can combine multiple background layers by comma-separating them \u2014 like adding patterns over gradients!",codeSamples:[{language:"css",code:`
.card {
  background-color: #f97316;
...
.hero-banner {
  ...
  height: 300px;
}`}]};case"css-pseudo-classes":return{slug:"css-pseudo-classes",title:"Pseudo-classes & Pseudo-elements",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F579}\uFE0F Pseudo-Classes (State-Based Styling)</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3AD} Pseudo-Elements (Add Content)</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1FA84} Real-World Example</h3>
    ...
    `,proTip:"Use pseudo-elements to add icons, highlights, or effects without touching your HTML \u2014 super handy for clean code!",codeSamples:[{language:"css",code:`
.button:hover {
  background-color: #f97316;
  color: white;
}`},{language:"css",code:`
...
input::placeholder {
  color: #999;
  font-style: italic;
}`}]};case"css-transitions-animations":return{slug:"css-transitions-animations",title:"Transitions & Animations",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9CA} CSS Transitions (Smooth Changes)</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F39E}\uFE0F CSS Animations (Looped or Keyframed)</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3A2} Real-World Analogy</h3>
      <p>\u{1F3AF} <strong>Transition</strong> is like a light switch dimming instead of flipping suddenly.  
         \u{1F3AC} <strong>Animation</strong> is like a full movie scene \u2014 you plan the motion frame by frame!</p>
    `,proTip:"Always add <code>transition</code> to the element\u2019s default state \u2014 not inside <code>:hover</code>!",codeSamples:[{language:"css",code:`
.card {
...
.icon {
  animation: bounce 1s infinite;
}`}]};case"css-responsive":return{slug:"css-responsive",title:"Responsive Design & Media Queries",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4F1} Why Responsiveness Matters</h3>
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9E0} How It Works</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4D0} Real-World Analogy</h3>
    ...
    `,proTip:"Start designing for small screens first (mobile-first), then scale up using media queries!",codeSamples:[{language:"css",code:`
.container {
  width: 100%;
  padding: 1rem;
}
...
@media (min-width: 1024px) {
  h1 {
    font-size: 2.5rem;
...
}`}]};case"css-variables":return{slug:"css-variables",title:"CSS Variables",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F501} Why Use Them?</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F527} How to Use</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Define theme variables in <code>:root</code> so they\u2019re accessible everywhere. Keep names readable like <code>--text-color</code>, <code>--btn-radius</code>, etc.",codeSamples:[{language:"css",code:`
:root {
...
body {
  ...
  color: var(--text-color);
}`}]};case"css-best-practices":return{slug:"css-best-practices",title:"Best Practices & Real Projects",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3D7}\uFE0F Start With a Plan</h3>
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4E6} Keep It Modular</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9FC} Clean Code Tips</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F680} Real Projects to Build</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F50D} Debug Like a Pro</h3>
    ...
    `,proTip:"Before you add a new class or style, ask: \u201CCan I reuse something I already made?\u201D \u2014 That\u2019s the CSS ninja mindset.",codeSamples:[{language:"css",code:`
...
.card {
  ...
  padding: 1.5rem;
  margin-bottom: 1rem;
}`}]};default:return}}export{o as CssTopicContent,t as CssTopics};
