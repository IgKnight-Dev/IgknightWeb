import"./chunk-EJUJSVO6.js";var e=[{id:"html-introduction",title:"Introduction to HTML",slug:"html-introduction"},{id:"html-basic-syntax",title:"HTML Syntax Basics",slug:"html-basic-syntax"},{id:"html-document-structure",title:"HTML Document Structure",slug:"html-document-structure"},{id:"html-headings-paragraphs",title:"Headings & Paragraphs",slug:"html-headings-paragraphs"},{id:"html-links-anchors",title:"Links & Anchors",slug:"html-links-anchors"},{id:"html-lists",title:"Lists in HTML",slug:"html-lists"},{id:"html-tables",title:"HTML Tables",slug:"html-tables"},{id:"html-multimedia",title:"Multimedia (Images, Audio, Video)",slug:"html-multimedia"},{id:"html-forms",title:"Forms & Inputs",slug:"html-forms"},{id:"html-embed",title:"Embed (SVG, Canvas, iframe)",slug:"html-embed"},{id:"html-semantic",title:"Semantic HTML",slug:"html-semantic"},{id:"html-meta-seo",title:"Meta Tags & SEO",slug:"html-meta-seo"},{id:"html-formatting",title:"Formatting & Text Tags",slug:"html-formatting"},{id:"html-accessibility",title:"Accessibility & ARIA",slug:"html-accessibility"},{id:"html-best-practices",title:"Best Practices",slug:"html-best-practices"}];function i(t){switch(t){case"html-introduction":return{slug:"html-introduction",title:"Introduction to HTML",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Real-World Uses of HTML</h3>
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9E0} The Human Body Analogy</h3>
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F50D} What is HTML Made Of?</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4DA} Common HTML Tags You\u2019ll Use Often</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F9F1} Basic HTML Document Structure</h3>
    ...
    `,proTip:"Use browser developer tools (right-click \u2192 Inspect) to explore the HTML behind any webpage!",codeSamples:[{language:"html",code:`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<a href="https://www.ignight.com">Visit IgKnight</a>`}]};case"html-document-structure":return{slug:"html-document-structure",title:"HTML Document Structure",content:`
          ...
          <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Real-World Example:</h3>
          <p>Think of it like a resume. The head contains your personal details, and body contains your full experience & skills.</p>
        `,proTip:"Always include meta viewport tag for mobile-friendly responsive pages.",codeSamples:[{language:"html",code:`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body>
    <h1>Hello World!</h1>
...
</html>`}]};case"html-basic-syntax":return{slug:"html-basic-syntax",title:"HTML Syntax Basics",content:`
        ...
        `,proTip:"Use code editors like VS Code with HTML formatter to auto-correct syntax.",codeSamples:[{language:"html",code:`
<h1>Heading</h1>
<p>This is a paragraph.</p>
<img src="logo.png" alt="Logo" />`}]};case"html-headings-paragraphs":return{slug:"html-headings-paragraphs",title:"Headings & Paragraphs",content:`
        ...
        `,proTip:"Never skip heading levels (e.g., don\u2019t go from h1 directly to h4).",codeSamples:[{language:"html",code:`
<h1>Page Title</h1>
<h2>Section 1</h2>
<p>This is a paragraph inside Section 1.</p>`}]};case"html-links-anchors":return{slug:"html-links-anchors",title:"Links & Anchors",content:`
      <p>Links connect different pages or resources. Without links, web navigation wouldn't exist!</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F517} Types of Links:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:'Always use meaningful link text for accessibility (avoid "click here").',codeSamples:[{language:"html",code:`
<!-- Internal link -->
...
<!-- Anchor link -->
<a href="#section2">Jump to Section 2</a>`}]};case"html-lists":return{slug:"html-lists",title:"Lists in HTML",content:`
      <p>Lists help organize related items together.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F522} Types of Lists:</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Use Case:</h3>
      <p>Use ordered lists for step-by-step instructions; unordered for general grouping.</p>
    `,proTip:"Use CSS to customize bullet styles or list markers.",codeSamples:[{language:"html",code:`
<!-- Unordered List -->
<ul>
  <li>Apple</li>
  <li>Banana</li>
...
<dl>
  ...
  <dd>HyperText Markup Language</dd>
</dl>`}]};case"html-multimedia":return{slug:"html-multimedia",title:"Multimedia (Images, Audio, Video)",content:`
      <p>Modern websites are rich with multimedia like images, audio, and video.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F5BC} Multimedia Elements:</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4A1} Real-Life Example:</h3>
      <p>Think of these like photos, songs, and movies inside your digital gallery!</p>
    `,proTip:"Always add alt text to images for accessibility.",codeSamples:[{language:"html",code:`
<!-- Image -->
...
<video controls width="400">
  <source src="movie.mp4" type="video/mp4">
</video>`}]};case"html-tables":return{slug:"html-tables",title:"HTML Tables",content:`
      <p>Tables are used to display data in a structured format with rows and columns.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F522} Table Anatomy:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Always add table headers for accessibility and screen readers.",codeSamples:[{language:"html",code:`
<table border="1">
  <thead>
    <tr>
  ...
  <tbody>
...
</table>`}]};case"html-forms":return{slug:"html-forms",title:"Forms & Inputs",content:`
      <p>Forms allow users to send data to the server \u2014 registration, login, search, etc.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4DD} Basic Form Elements:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Always label your form fields properly for accessibility.",codeSamples:[{language:"html",code:`
<form>
  <label>Name: <input type="text" name="name"></label><br>
  <label>Email: <input type="email" name="email"></label><br>
  <label>Password: <input type="password" name="password"></label><br>
  <button type="submit">Submit</button>
</form>`}]};case"html-semantic":return{slug:"html-semantic",title:"Semantic HTML",content:`
      <p>Semantic HTML means using tags that clearly describe the meaning of the content inside them.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3AF} Why Semantic HTML Matters?</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4DA} Examples of Semantic Tags:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Write HTML like you\u2019re writing a story \u2014 structure matters!",codeSamples:[{language:"html",code:`
<header>
  <h1>My Blog</h1>
  <nav>...</nav>
</header>
...
<footer>Copyright \xA9 2025</footer>`}]};case"html-meta-seo":return{slug:"html-meta-seo",title:"Meta Tags & SEO",content:`
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F680} Key Meta Tags:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Write unique & descriptive meta descriptions for better SEO rankings.",codeSamples:[{language:"html",code:`
<head>
  <title>IgKnight Learning Platform</title>
  <meta charset="UTF-8">
  <meta name="description" content="Master web development easily with IgKnight.">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>`}]};case"html-formatting":return{slug:"html-formatting",title:"Formatting & Text Tags",content:`
      <p>HTML provides various tags to format text, highlight important parts, and improve content clarity.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F58B} Common Formatting Tags:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Use semantic formatting tags (like &lt;strong&gt;) when possible for accessibility.",codeSamples:[{language:"html",code:`
<p>This is <strong>important</strong> and <em>emphasized</em> text.</p>
<p>Math: H<sub>2</sub>O</p>
<p>Old price: <del>$99</del> New price: <ins>$49</ins></p>`}]};case"html-embed":return{slug:"html-embed",title:"Embed (SVG, Canvas, iframe)",content:`
      <p>Embedding allows you to insert external or interactive content inside your webpage.</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F3AF} Embedding Options:</h3>
      <ul class="list-disc list-inside text-gray-300">
    ...
    `,proTip:"Use iframe carefully \u2014 avoid overusing external sources that affect performance.",codeSamples:[{language:"html",code:`
...
<svg width="100" height="100">
  <circle cx="50" cy="50" r="40" stroke="orange" stroke-width="4" fill="yellow" />
</svg>`}]};case"html-accessibility":return{slug:"html-accessibility",title:"Accessibility & ARIA",content:`
    ...
    `,proTip:"Test your website with screen readers and keyboard-only navigation.",codeSamples:[{language:"html",code:`
...
<button aria-label="Close">X</button>`}]};case"html-best-practices":return{slug:"html-best-practices",title:"Best Practices",content:`
      <p>Follow these best practices to write clean, maintainable, and professional HTML code:</p>

      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F4CC} Best Practices Checklist:</h3>
      <ul class="list-disc list-inside text-gray-300">
      ...
      <h3 class="text-lg font-semibold mt-4 mb-2 text-white">\u{1F680} Real Impact:</h3>
    ...
    `,proTip:"Regularly review your code and validate to ensure standards compliance.",codeSamples:[{language:"html",code:`
<!-- Clean, semantic, accessible code -->
<article>
  <h2>Learning HTML Best Practices</h2>
  <p>Start writing clean code from day one.</p>
</article>`}]};default:return}}export{i as HtmlTopicContent,e as HtmlTopics};
